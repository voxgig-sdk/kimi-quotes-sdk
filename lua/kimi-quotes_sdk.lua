...
local KimiQuotesSDK = {}
KimiQuotesSDK.__index = KimiQuotesSDK
...
KimiQuotesSDK._make_feature = _make_feature


function KimiQuotesSDK.new(options)
  local self = setmetatable({}, KimiQuotesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KimiQuotesSDK:options_map()
...
function KimiQuotesSDK:get_utility()
  return Utility.copy(self._utility)
end


function KimiQuotesSDK:get_root_ctx()
  return self._rootctx
end


function KimiQuotesSDK:prepare(fetchargs)
...
function KimiQuotesSDK:direct(fetchargs)
...
-- by passing it.
function KimiQuotesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KimiQuotesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KimiQuotesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KimiQuotesSDK:Quote(data)
...
function KimiQuotesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KimiQuotesSDK.new(sdkopts)
  sdk.mode = "test"
