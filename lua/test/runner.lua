...
function runner.env_override(m)
  local live = runner.getenv("KIMI_QUOTES_TEST_LIVE")
  local override = runner.getenv("KIMI_QUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KIMI_QUOTES_TEST_EXPLAIN")
