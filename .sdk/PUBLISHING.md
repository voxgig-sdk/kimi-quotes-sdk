...
|---|---|---|
| `ts/` | @voxgig-sdk/kimi-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kimi-quotes-sdk \
      --repository voxgig-sdk/kimi-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kimi-quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kimi-quotes-sdk --id=<id>` removes it.
