...
// KimiQuotes SDK timeout feature
...
class KimiQuotesTimeoutFeature extends KimiQuotesBaseFeature
{
    ...
    private function _with_timeout(KimiQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KimiQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
