...
class KimiQuotesNetsimFeature extends KimiQuotesBaseFeature
{
    ...
    private function _simulate(KimiQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KimiQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
