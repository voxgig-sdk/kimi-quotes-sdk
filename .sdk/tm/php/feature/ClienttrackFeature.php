...
// KimiQuotes SDK clienttrack feature
...
class KimiQuotesClienttrackFeature extends KimiQuotesBaseFeature
{
    ...
    public function PostConstruct(KimiQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KimiQuotes-SDK';
