...
// KimiQuotes SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KimiQuotesTestFeature extends KimiQuotesBaseFeature
{
    ...
    public function init(KimiQuotesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KimiQuotesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KimiQuotesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KimiQuotesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KimiQuotesContext $ctx, $op, $args): array
    {
