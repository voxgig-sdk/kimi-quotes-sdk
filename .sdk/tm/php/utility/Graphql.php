...
// KimiQuotes SDK utility: graphql
//
...
class KimiQuotesGraphql
{
    ...
    // equivalent.
    public static function body(KimiQuotesContext $ctx): mixed
    {
    ...
    public static function errors(KimiQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
