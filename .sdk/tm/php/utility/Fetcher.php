...
// KimiQuotes SDK utility: fetcher

class KimiQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KimiQuotesSDK/1.0)';
    ...
    public static function call(KimiQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
