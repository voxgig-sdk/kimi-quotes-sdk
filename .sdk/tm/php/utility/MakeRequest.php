...
// KimiQuotes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KimiQuotesMakeRequest
{
    public static function call(KimiQuotesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KimiQuotesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KimiQuotesResponse($fetched);
        } else {
