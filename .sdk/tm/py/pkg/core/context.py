...
from projectname_sdk.core.control import KimiQuotesControl
...
class KimiQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, KimiQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KimiQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KimiQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KimiQuotesError(code, msg, self)
