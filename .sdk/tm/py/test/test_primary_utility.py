...
from projectname_sdk import KimiQuotesSDK
from projectname_sdk.core.spec import KimiQuotesSpec
from projectname_sdk.core.result import KimiQuotesResult
from projectname_sdk.core.response import KimiQuotesResponse
from projectname_sdk.core.operation import KimiQuotesOperation
from projectname_sdk.core.error import KimiQuotesError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import KimiQuotesBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return KimiQuotesError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = KimiQuotesSDK.test(None, None)
        ...
        class TestInitFeature(KimiQuotesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(KimiQuotesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = KimiQuotesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = KimiQuotesSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = KimiQuotesSDK.test(None, setup_opts)
