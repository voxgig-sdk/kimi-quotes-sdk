...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kimi-quotes` | `npm install @voxgig-sdk/kimi-quotes` |
| Python | `voxgig-sdk-kimi-quotes` | `pip install voxgig-sdk-kimi-quotes` |
| PHP | `voxgig-sdk/kimi-quotes` | `composer require voxgig-sdk/kimi-quotes` |
| Golang | `github.com/voxgig-sdk/kimi-quotes-sdk/go` | `go get github.com/voxgig-sdk/kimi-quotes-sdk/go` |
| Ruby | `voxgig-sdk-kimi-quotes` | `gem install voxgig-sdk-kimi-quotes` |
| Lua | `voxgig-sdk-kimi-quotes` | `luarocks install voxgig-sdk-kimi-quotes` |
