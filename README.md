...
| Ruby | `voxgig-sdk-kimi-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/releases) |
| Lua | `voxgig-sdk-kimi-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/releases) |
