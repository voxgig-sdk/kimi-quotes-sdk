...
The Kimi Quotes API provides access to a collection of quotes from Finnish Formula 1 driver Kimi Räikkönen, including team radio snippets and interview quotes.

Learn more about Kimi Quotes API at [kimiquotes.pages.dev](https://kimiquotes.pages.dev).

This is an unofficial SDK for the Kimi Quotes public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kimi-quotes-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/tags) |
| Python | `voxgig-sdk-kimi-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/tags) |
| PHP | `voxgig-sdk/kimi-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/tags) |
| Golang | `github.com/voxgig-sdk/kimi-quotes-sdk/go` | `go get github.com/voxgig-sdk/kimi-quotes-sdk/go@latest` |
| Ruby | `voxgig-sdk-kimi-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/tags) |
| Lua | `voxgig-sdk-kimi-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/kimi-quotes-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/kimi-quotes-sdk/go-cli` | `go install github.com/voxgig-sdk/kimi-quotes-sdk/go-cli/cmd/kimi-quotes@latest` |
| Go MCP server | `github.com/voxgig-sdk/kimi-quotes-sdk/go-mcp` | `go get github.com/voxgig-sdk/kimi-quotes-sdk/go-mcp@latest` |
...
$quotes = $client->Quote()->list();
print_r(array_map(fn($item) => $item->data_get(), $quotes));
...
- Upstream API: [https://kimiquotes.pages.dev/](https://kimiquotes.pages.dev/)
