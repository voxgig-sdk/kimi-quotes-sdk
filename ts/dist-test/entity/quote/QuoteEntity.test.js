...
(0, node_test_1.describe)('QuoteEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('KIMI_QUOTES_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.KimiQuotesSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.KimiQuotesSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.KimiQuotesSDK(merge([
