...
(0, node_test_1.describe)('QuoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KimiQuotesSDK({
...
function liveScenariosActive() { return false && process.env.KIMI_QUOTES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KimiQuotesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KIMI_QUOTES_TEST_QUOTE_ENTID'];
    ...
    const client = new __1.KimiQuotesSDK({
        base: 'http://localhost:8080',
