...
function envOverride(m) {
    if ('TRUE' === process.env.KIMI_QUOTES_TEST_LIVE ||
        'TRUE' === process.env.KIMI_QUOTES_TEST_OVERRIDE) {
    ...
    m.KIMI_QUOTES_TEST_EXPLAIN = process.env.KIMI_QUOTES_TEST_EXPLAIN || m.KIMI_QUOTES_TEST_EXPLAIN;
    return m;
}
