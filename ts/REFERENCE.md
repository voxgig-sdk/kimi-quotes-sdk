# KimiQuotes TypeScript SDK Reference

Complete API reference for the KimiQuotes TypeScript SDK.
...
```ts
new KimiQuotesSDK(options?: object)
```
...
#### `KimiQuotesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `KimiQuotesSDK` instance in test mode.
...
Return the parent `KimiQuotesSDK` instance.
