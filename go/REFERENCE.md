# KimiQuotes Golang SDK Reference

Complete API reference for the KimiQuotes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *KimiQuotesSDK`
...
#### `Quote(data map[string]any) KimiQuotesEntity`
