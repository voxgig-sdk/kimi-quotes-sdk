...
{
    private static function utility(): KimiQuotesUtility
    {
        return new KimiQuotesUtility();
    }
    ...
    private static function ctx(array $over = []): KimiQuotesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KimiQuotesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KimiQuotesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KimiQuotesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KimiQuotesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KimiQuotesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KimiQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KimiQuotesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KimiQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KimiQuotesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KimiQuotesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KimiQuotesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KimiQuotesResponse([]),
            'result' => new KimiQuotesResult([]),
        ]);
        [, $err] = KimiQuotesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KimiQuotesSpec([]),
            'response' => null,
            'result' => new KimiQuotesResult([]),
        ]);
        [, $err] = KimiQuotesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KimiQuotesSpec(['step' => 's']),
            'response' => new KimiQuotesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KimiQuotesResult([]),
        ]);
        [, $err] = KimiQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KimiQuotesSpec(['step' => 's']),
            'response' => new KimiQuotesResponse(self::resp(200, ['v' => 1])),
            'result' => new KimiQuotesResult([]),
        ]);
        [, $err] = KimiQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KimiQuotesSpec(['step' => 's']),
            'response' => new KimiQuotesResponse(self::resp(200, ['v' => 2])),
            'result' => new KimiQuotesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KimiQuotesMakeResponse::call($ctx);
    ...
    {
        $preset = new KimiQuotesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KimiQuotesSpec([]),
            'response' => new KimiQuotesResponse([]),
            'result' => new KimiQuotesResult([]),
        ...
        [$got, $err] = KimiQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KimiQuotesResult([])]);
        [, $err] = KimiQuotesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KimiQuotesSpec([]), 'result' => null]);
        [, $err] = KimiQuotesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KimiQuotesSpec(['step' => 's']),
            'result' => new KimiQuotesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KimiQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KimiQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KimiQuotesSpec(['step' => 's']),
            'result' => new KimiQuotesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KimiQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KimiQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KimiQuotesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KimiQuotesSpec([]),
            'result' => new KimiQuotesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KimiQuotesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KimiQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KimiQuotesError('boom', 'boom');
        $utility->fetcher = function (KimiQuotesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KimiQuotesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KimiQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KimiQuotesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KimiQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KimiQuotesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        KimiQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KimiQuotesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KimiQuotesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KimiQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KimiQuotesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KimiQuotesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KimiQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KimiQuotesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KimiQuotesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KimiQuotesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KimiQuotesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KimiQuotesResult(['ok' => false])]);
        $this->expectException(KimiQuotesError::class);
        KimiQuotesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KimiQuotesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KimiQuotesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KimiQuotesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KimiQuotesBaseFeature();
        $b = new KimiQuotesBaseFeature();
        KimiQuotesFeatureAdd::call($ctx, $a);
        KimiQuotesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KimiQuotesBaseFeature
    {
        $f = new KimiQuotesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KimiQuotesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KimiQuotesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KimiQuotesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KimiQuotesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        KimiQuotesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KimiQuotesResponse(['headers' => null]),
            'result' => new KimiQuotesResult([]),
        ]);
        KimiQuotesResultHeaders::call($ctx);
