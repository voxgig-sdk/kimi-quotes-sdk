...
// KimiQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KimiQuotesSDK::test)
...
{
    private const SDK_CLASS = 'KimiQuotesSDK';
    ...
    private const SDK_BASE = 'kimiquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kimiquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
