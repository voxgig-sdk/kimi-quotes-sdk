...
// KimiQuotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KimiQuotesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KimiQuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(KimiQuotesOmni::structfix($val, Struct::undef()))) {
