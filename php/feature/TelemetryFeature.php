...
// KimiQuotes SDK telemetry feature
...
class KimiQuotesTelemetryFeature extends KimiQuotesBaseFeature
{
    ...
    private function _close(KimiQuotesContext $ctx, bool $ok): void
    {
