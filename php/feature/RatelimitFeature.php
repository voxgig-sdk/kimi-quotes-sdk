...
// KimiQuotes SDK ratelimit feature
...
class KimiQuotesRatelimitFeature extends KimiQuotesBaseFeature
{
    ...
    private function _acquire(KimiQuotesContext $ctx): void
    {
    ...
    private function _track(KimiQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
