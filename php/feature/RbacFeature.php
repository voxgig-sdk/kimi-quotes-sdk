...
class KimiQuotesRbacFeature extends KimiQuotesBaseFeature
{
    ...
    private function _required(KimiQuotesContext $ctx): ?string
    {
    ...
    private function _reject(KimiQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(KimiQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
