...
class KimiQuotesProxyFeature extends KimiQuotesBaseFeature
{
    ...
    public function init(KimiQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KimiQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
