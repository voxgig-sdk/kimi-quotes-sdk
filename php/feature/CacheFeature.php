...
class KimiQuotesCacheFeature extends KimiQuotesBaseFeature
{
    ...
    private function _through(KimiQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
