...
// KimiQuotes SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KimiQuotesTransformResponse
{
    public static function call(KimiQuotesContext $ctx): mixed
    {
        ...
        $transform = KimiQuotesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
