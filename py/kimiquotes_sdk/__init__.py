...
from kimiquotes_sdk.utility import register

# Load features
from kimiquotes_sdk.feature.base_feature import KimiQuotesBaseFeature
from kimiquotes_sdk.features import _has_feature, _make_feature
...
class KimiQuotesSDK:
    ...
    def get_utility(self):
        return KimiQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KimiQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Quote(self, data=None) -> "QuoteEntity":
        ...
        from kimiquotes_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "KimiQuotesSDK":
        if sdkopts is None:
            sdkopts = {}
