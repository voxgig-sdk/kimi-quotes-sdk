...
class KimiQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KimiQuotesTestRunner.getenv("KIMIQUOTES_TEST_LIVE")
        override = KimiQuotesTestRunner.getenv("KIMIQUOTES_TEST_OVERRIDE")
        ...
        explain = KimiQuotesTestRunner.getenv("KIMIQUOTES_TEST_EXPLAIN")
