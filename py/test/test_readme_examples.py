# KimiQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KimiQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KimiQuotesSDK(...) and KimiQuotesSDK.test(...) become
#      KimiQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kimiquotes_sdk"
_SDK_CLASS = "KimiQuotesSDK"
