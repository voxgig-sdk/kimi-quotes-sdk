...
func registerSDKWords(r *eng.Registry, client *sdk.KimiQuotesSDK) {
...
func runOp(client *sdk.KimiQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
