// Command KimiQuotes-mcp is an MCP server exposing the KimiQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KimiQuotes_list  — list records of an entity
//	KimiQuotes_load  — load a single record of an entity
//
