...
type Args struct {
	Entity string         `json:"entity" jsonschema:"quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KimiQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kimi-quotes_list",
		Description: "List records from KimiQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kimi-quotes_load",
		Description: "Load a single record from KimiQuotes. " +
...
func runOp(client *sdk.KimiQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KimiQuotesSDK, name string) (sdk.KimiQuotesEntity, error) {
